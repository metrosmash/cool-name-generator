...
i also added my own function that lets you add your name to the function then you can use the 
adjective to create different unique names with the combo adjective - word of your choosing 
